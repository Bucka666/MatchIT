...
def deep_grade():
    ...
    try:
        ...
        prompt = (
            ...
            f"Any severe corner damage — missing material, torn corners, bad bends, or folds — score MUST be 2.0 or below, label MUST be Good or Poor. No exceptions.\n"
            f"- Visible crease, fold, or bend in the card body → score MUST be 3.0 or below, label Very Good or below\n"
            f"- Heavy surface crease or deep scratch → score MUST be 5.0 or below, label Excellent or below\n"
...
Any severe corner damage — missing material, torn corners, bad bends, or folds — score MUST be 2.0 or below, label MUST be Good or Poor. No exceptions.
- Visible crease, fold, or bend in the card body → score MUST be 3.0 or below, label Very Good or below
- Heavy surface crease or deep scratch → score MUST be 5.0 or below, label Excellent or below
...
def _rule_based_grade(image_path):
    try:
        ...
        if score >= 10.0:  label = "Gem Mint"
        elif score >= 9.0: label = "Mint"
        elif score >= 8.0: label = "Near Mint-Mint"
        elif score >= 7.0: label = "Near Mint"
        elif score >= 6.0: label = "Excellent-Mint"
        elif score >= 5.0: label = "Excellent"
        elif score >= 4.0: label = "Very Good-Excellent"
        elif score >= 3.0: label = "Very Good"
        elif score >= 2.0: label = "Good"
        else:              label = "Poor"
