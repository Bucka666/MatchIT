...
def deep_grade():
    ...
    try:
        ...
        prompt = (
            ...
            f"STEP 1 — Check for hard defects first. These override everything else:\n"
            f"- Missing corner or chunk of card (check all 4 corners carefully — even one missing corner means score MUST be 3.0 or below, label Damaged)\n"
            f"- Visible crease, fold, or bend in the card body → score MUST be 5.0 or below, label Played or Damaged\n"
            f"- Heavy surface crease or deep scratch → score MUST be 6.0 or below\n"
            f"If any hard defect is present, apply the ceiling and do not score higher regardless of other attributes.\n\n"
            f"STEP 2 — If no hard defects, assess these aspects normally:\n"
            f"1. Centering (are borders even on all sides?)\n"
            f"2. Corners (TCG cards have naturally rounded corners by design — do NOT penalise normal rounded corners. Only flag corners that have additional damage: missing pieces, chips, bends, or fraying beyond the natural card shape)\n"
            ...
            f'  "summary": "<2-3 sentence plain English explanation, explicitly naming any hard defects found>"\n'
            f'}}'
        )
...
STEP 1 — Check for hard defects first. These override everything else:
- Missing corner or chunk of card (check all 4 corners carefully — even one missing corner means score MUST be 3.0 or below, label Damaged)
- Visible crease, fold, or bend in the card body → score MUST be 5.0 or below, label Played or Damaged
- Heavy surface crease or deep scratch → score MUST be 6.0 or below
If any hard defect is present, apply the ceiling and do not score higher regardless of other attributes.

STEP 2 — If no hard defects, assess these aspects normally:
1. Centering (are borders even on all sides?)
2. Corners (TCG cards have naturally rounded corners by design — do NOT penalise normal rounded corners. Only flag corners that have additional damage: missing pieces, chips, bends, or fraying beyond the natural card shape)
...
{{
  ...
  "summary": "<2-3 sentence plain English explanation, explicitly naming any hard defects found>"
}}"""
