...
def deep_grade():
    ...
    try:
        ...
        prompt = (
            ...
            f"RULE A — Missing corner: If any part of a corner is physically absent (card material is gone, not just bent or rounded) → score MUST be 1.0, label MUST be Poor. This is non-negotiable.\n"
...
RULE A — Missing corner: If any part of a corner is physically absent (card material is gone, not just bent or rounded) → score MUST be 1.0, label MUST be Poor. This is non-negotiable.
