...
def deep_grade():
    ...
    try:
        ...
        prompt = (
            ...
            f"Any severe corner damage — missing material, torn corners, bad bends, or folds — score MUST be 3.0 or below, label MUST be Damaged. No exceptions.\n"
            f"- Visible crease, fold, or bend in the card body → score MUST be 3.0 or below, label Damaged\n"
...
Any severe corner damage — missing material, torn corners, bad bends, or folds — score MUST be 3.0 or below, label MUST be Damaged. No exceptions.
- Visible crease, fold, or bend in the card body → score MUST be 3.0 or below, label Damaged
