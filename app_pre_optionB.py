...
def deep_grade():
    ...
    try:
        ...
        prompt = (
            ...
            f"RULE A — Missing corner: Examine all four corners. A missing corner means the card material is physically absent — the corner point does not exist, the edge is irregular or jagged where it should taper to a point, and you can see the card ends abruptly rather than forming a corner. This is different from a bent or rounded corner. If ANY corner has physically absent material → score MUST be 1.0, label MUST be Poor. This is non-negotiable.\n"
            f"RULE B — Crease or fold: If the card body has any visible crease, fold, or bend that has broken the card surface → score MUST be 3.0 or below, label Very Good or below.\n"
...
RULE A — Missing corner: Examine all four corners. A missing corner means the card material is physically absent — the corner point does not exist, the edge is irregular or jagged where it should taper to a point, and you can see the card ends abruptly rather than forming a corner. This is different from a bent or rounded corner. If ANY corner has physically absent material → score MUST be 1.0, label MUST be Poor. This is non-negotiable.
RULE B — Crease or fold: If the card body has any visible crease, fold, or bend that has broken the card surface → score MUST be 3.0 or below, label Very Good or below.
