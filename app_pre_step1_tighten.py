...
def deep_grade():
    ...
    try:
        ...
        prompt = (
            ...
            f"STEP 1 — Hard defect check. Examine all four corners closely.\n"
            f"A missing corner means part of the card material is physically absent — not rounded, not frayed, but gone. "
            f"If ANY corner has missing card material, score MUST be 3.0 or below, label MUST be Damaged. No exceptions.\n"
            ...
            f"Hard defect ceilings are absolute — do not score higher regardless of other attributes.\n\n"
...
STEP 1 — Hard defect check. Examine all four corners closely.
A missing corner means part of the card material is physically absent — not rounded, not frayed, but gone. If ANY corner has missing card material, score MUST be 3.0 or below, label MUST be Damaged. No exceptions.
...
Hard defect ceilings are absolute — do not score higher regardless of other attributes.
