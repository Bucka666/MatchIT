...
def deep_grade():
    ...
    try:
        ...
        prompt = (
            ...
            f"Any severe corner damage — missing material, torn corners, bad bends, or folds — score MUST be 1.0, label MUST be Poor. No exceptions. This mirrors PSA 1.\n"
            f"- Visible crease, fold, or bend in the card body → score MUST be 3.0 or below, label Very Good or below. This mirrors PSA 3.\n"
            f"- Heavy surface crease or deep scratch → score MUST be 5.0 or below, label Excellent or below. This mirrors PSA 5.\n"
...
Any severe corner damage — missing material, torn corners, bad bends, or folds — score MUST be 1.0, label MUST be Poor. No exceptions. This mirrors PSA 1.
- Visible crease, fold, or bend in the card body → score MUST be 3.0 or below, label Very Good or below. This mirrors PSA 3.
- Heavy surface crease or deep scratch → score MUST be 5.0 or below, label Excellent or below. This mirrors PSA 5.
