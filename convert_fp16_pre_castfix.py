...
print("[fp16] converting (disable_shape_infer=True) ...", flush=True)
m16 = float16.convert_float_to_float16(
    onnx.load(FP32), keep_io_types=True, disable_shape_infer=True,
    op_block_list=float16.DEFAULT_OP_BLOCK_LIST + ["Range", "Cast", "Div"],
)
onnx.save(m16, FP16)
